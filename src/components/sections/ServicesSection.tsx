    ...
    <section id="services" className="py-16 sm:py-24">
      <div className="container">
        ...
        <Tabs defaultValue="service" className="mt-8">
            <TabsList className="grid w-full grid-cols-3 max-w-md mx-auto h-auto rounded-xl p-2 shadow-lg bg-gray-100 dark:bg-gray-800">
                <TabsTrigger value="service" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-md rounded-lg">Service</TabsTrigger>
                <TabsTrigger value="technology" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-md rounded-lg">Technology</TabsTrigger>
                <TabsTrigger value="industry" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-md rounded-lg">Industry</TabsTrigger>
            </TabsList>
